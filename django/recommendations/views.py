...
from .models import User, Review, CombinationPost, Ingredient, Combination, Menu, Dib
...
def hybrid_recommendation(request, user_id):
    ...
    response = response_dto(content_based_result,collaborative_result,combination_posts, ingredients, combinations, menus)
    return Response(response)
