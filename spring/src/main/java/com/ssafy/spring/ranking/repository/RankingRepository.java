...
public interface RankingRepository extends JpaRepository<Ranking, Integer> {
    @Query(value = "select new com.ssafy.spring.ranking.dto.RankingDto(ranking.rankingId, menu.menuId, menu.menuName, menu.imgUrl, ranking.rankDate, ranking.data) " +
...
//
    @Query(value = "select u.user_id userId, u.user_name userName, cnt, o.ranking ranking " +
            "from (" +
            "select oh.user_id, oh.menu_id, sum(oh.count) cnt, rank() over(order by sum(count) desc) ranking " +
