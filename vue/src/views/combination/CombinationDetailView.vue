  ...
  <div>
    <div class="top" style="background-color: white">
      <v-row>
        ...
        <v-col class="mt-1 ml-6"><h3>꿀조합 정보</h3></v-col>
      </v-row>
    </div>
    <div align="center" class="pt-13">
      ...
      <div class="ml-30">
        <div class="left"><h2 style="font-size: 19px">단백질 보충원</h2></div>
        <div class="left ml-2">
      ...
      <div class="ma-4 pt-6 pb-3">
        <div style="font-size: 16px">헬창들을 위한 터키 아보카도 베이컨 샌드위치를 즐겨보세요!</div>
      </div>
    ...
    <br />
    <br />
    <v-card height="4" width="360" elevation="0" style="background-color: #239347">&nbsp;</v-card>
    ...
    <div>
      ...
      <v-tabs-items v-model="tab">
        <v-tab-item v-for="item in items" :key="item">
          <v-card v-if="item == '조합정보'" flat height="200">
            <div class="pt-4 pl-6 pr-6">
              <combi-detail-info></combi-detail-info>
            </div>
          </v-card>
          <v-card v-else-if="item == '영양정보'" flat height="200">
            <div class="pt-4 pl-6 pr-6">
