<template>
  <div class="body">
    <div class="title"><h4 style="font-size: 22px">썹bti</h4></div>
    <div class="backbar">
      <v-btn @click="goBack" icon><v-icon>mdi-arrow-left</v-icon></v-btn>
      <progress value="2" max="2"></progress>
    </div>
    <v-card class="home_card_b mt-2" elevation="3" outlined>
      <h3 class="pt-3"><span style="color: #239347">썹BTI</span> 란?</h3>
      <div class="pt-2" style="font-size: 15px">
        <p>내 입맛에 어울리는 서브웨이 조합은?!</p>
        <p class="mt-n2">나의 입맛 그룹을 진단받고,</p>
        <p class="mt-n2">나와 같은 입맛을 가진 사람들이</p>
        <p class="mt-n2">선호하는 메뉴를 추천받을 수 있습니다!</p>
      </div>
    </v-card>
    <div class="subti">
      <div class="question">
        <div class="statement">
          <span
            >찐 감자를 먹을 때 소금보다는 설탕에<br />
            찍어 먹는 것을 선호한다.</span
          >
        </div>
        <div class="decision">
          <div class="agree" style="font-size: 15px">동의</div>
          <div class="radio">
            <input
              type="radio"
              name="question1"
            ...
            <input
              ...
              value="7"
              v-model="question1"
              class="radiobtn mbbtn right"
            />
          </div>
          <div class="disagree" style="font-size: 15px">비동의</div>
        </div>
      </div>
    </div>
    <div class="subti">
