    ...
    <v-card height="680">
      ...
      <v-card-actions class="pl-5 pb-5">
        <div style="font-size: 18px; font-weight: 900">
          총&nbsp; {{ combiListItem.combination.price | comma }}원
        </div>
        <v-spacer></v-spacer>
...
import CombiInfoIngredient from "@/components/common/mypage/CombiInfoIngredientMyCombi.vue";
import CombiInfoNutrition from "@/components/common/mypage/CombiInfoNutritionMyCombi.vue";

export default {
  name: "CombiModalMyCombiMyZzim",
