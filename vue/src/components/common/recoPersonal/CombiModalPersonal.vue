...
<script>
import CombiInfoSnad from "@/components/common/recoPersonal/CombiInfoSandPersonal.vue";
import CombiInfoIngredient from "@/components/common/recoPersonal/CombiInfoIngredientPersonal.vue";
import CombiInfoNutrition from "@/components/common/CombiInfoNutrition.vue";

export default {
  name: "CombiModalPersonal",
